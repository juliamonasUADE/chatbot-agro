...
def tiene_palabras_reales(pregunta):
    palabras_comunes = {
        ...
        "quiero", "puedo", "puede", "tienen", "tengo", "tenés",
        ...
        "apicultores", "apicultor", "colmenas", "colmena", "miel",
        "huerta", "huertas", "familiar", "familiares",
        "productores", "productor", "hortícola", "horticola",
        "horticultura", "hidropónica", "hidroponica", "hidroponía", "hidroponia",
        "establecimientos", "establecimiento",
        "microempresas", "microempresa", "pymes", "mipymes",
        "fondos", "financiamiento", "financiacion", "financiación", "crédito", "credito",
        "pesca", "deportiva", "deportivo",
        "cervecería", "cerveceria", "cervecerías", "cervecerias",
        "artesanal", "artesanales",
        "unidades", "productivas", "agropecuarias", "agropecuario",
        "cerdos", "cerdo", "porcino", "porcinos", "porcinocultura",
        "kiwi", "fruticultura", "verduras", "verdura", "hortalizas",
        "colmenas", "colmena", "miel", "apícola", "apicola",
        "suelos", "suelo", "tierra", "tierras",
        "exporta", "exportar", "exportación", "exportacion",
        "inversión", "inversion", "invertir", "inversiones",
        "digital", "internet", "web", "redes", "instagram", "facebook",
        "personal", "empleados", "trabajadores", "capacitación", "capacitacion",
        "cerveza", "turismo", "turistico", "turístico",
    }
